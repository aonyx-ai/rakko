...
///
/// Nothing here is a problem of the project. A diagnostic of clippy, whether
/// a warning or an error of the compiler, travels as a finding in the
...
pub enum LintRustError {
    ...
    ///
    /// A run lints every workspace of the project, and a run that does not
